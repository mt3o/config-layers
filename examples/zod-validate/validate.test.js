...
try {
    zod = await import('zod'); z = zod.z;
    hasDependenciesInstalled = true;
} catch (_e) {
    console.info("Missing dependency: zod not installed");
}

// ⬇️ Conditionally run the test suite ⬇️
if (!hasDependenciesInstalled) {
    describe('Skipping zod validation tests, zod is not installed', () => {
        it('Skipping zod validation tests, zod is not installed', () => {
